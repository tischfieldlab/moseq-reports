                    ...
                    <template v-for="node in groupedData">
                        <g class="boxplot" :key="node.group">
                            ...
                            <rect
                                ...
                                :height="
                                    scale.y(node.q3) - scale.y(node.q1) || 0
                                "
                ...
                <g v-if="show_violinplot">
                    <template v-for="node in groupedData">
                        <g
                            class="violin"
                            :key="node.group"
                            :transform="`translate(${scale.x(node.group)}, 0)`"
                        >
                            <path
                                :d="violinArea(node.kde)"
                                :style="{ fill: scale.c(node.group) }"
                            />
                        </g>
                    </template>
                ...
                <g v-if="actuallyShowPoints" class="node">
                    <template v-for="node in points">
                        ...
                        <path
                            ...
                            :d="diamond()"
                            :transform="`translate(${
                                scale.x(node.group) + node.jitter + halfBandwith
                            }, ${scale.y(node.value)})`"
                            :style="{
                                fill: scale.c(node.group),
                                stroke: '#000000',
