        ...
        <b-row v-show="row_order_type === 'value'">
            ...
            <b-col>
                <b-input-group prepend="Sort by">
                    <b-form-select
                        v-model="row_order_column_value"
...
export default mixins(WindowMixin).extend({
    ...
    watch: {
        column_options: {
            handler() {
                if (
                    this.row_order_column_value === undefined &&
                    this.column_options.length > 0
                ) {
