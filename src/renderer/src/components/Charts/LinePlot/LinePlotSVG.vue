    ...
    <div>
        ...
        >
                    ...
                    <g class="series" :key="g" :data-series="`${g}`">
                        ...
                        <g class="series-points">
                            <template v-for="p in sdata">
                                <g
                                    :key="`${p[seriesKey]}-${p[varKey]}`"
                                    :data-series="`${p[seriesKey]}`"
                                    :data-var="`${p[varKey]}`"
                                >
                                    <g
                                        v-if="errorKey && showError"
                                        class="error"
                                    >
                                        <line
                                            class="error"
            ...
            <g
                ...
                v-axis:x="scale"
                :transform="`translate(${margin.left},${origin.y})`"
            >
            ...
            if (event && event.target !== null) {
                ...
                if (target.dataset.var) {
                    ...
                    this.hoverItem = this.data.find((itm) => {
                        return (
                            itm[this.varKey].toString() ===
                                target.dataset.var &&
                            itm[this.seriesKey].toString() ===
