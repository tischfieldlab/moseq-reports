<template>
    <b-container fluid>
        ...
        <b-row v-if="layout === 'grid'">
            <b-col cols="1"></b-col>
            <b-col>
                <b-form-checkbox switch v-model="grid_avoid_overlap"
                    >Avoid Overlap</b-form-checkbox
                >
            </b-col>
        </b-row>
        <b-row v-if="layout === 'grid' && grid_avoid_overlap === true">
            ...
            <b-col>
                <b-input-group prepend="Avoid Overlap Padding">
                    <b-form-input
                        v-model="grid_avoid_overlap_padding"
                        type="number"
                        :number="true"
                        step="10"
                        min="0"
        ...
        <b-row v-if="layout === 'circle'">
            <b-col cols="1"></b-col>
            <b-col>
                <b-form-checkbox switch v-model="circle_avoid_overlap"
                    >Avoid Overlap</b-form-checkbox
                >
            </b-col>
        </b-row>
        <b-row v-if="layout === 'circle'">
            <b-col cols="1"></b-col>
            <b-col>
                <b-form-checkbox switch v-model="circle_clockwise"
                    >Clockwise</b-form-checkbox
                >
            </b-col>
        </b-row>
        ...
        <b-row v-if="layout === 'concentric'">
            <b-col cols="1"></b-col>
            <b-col>
                <b-form-checkbox switch v-model="concentric_avoid_overlap"
                    >Avoid Overlap</b-form-checkbox
                >
            </b-col>
        </b-row>
        <b-row v-if="layout === 'concentric'">
            <b-col cols="1"></b-col>
            <b-col>
                <b-form-checkbox switch v-model="concentric_clockwise"
                    >Clockwise</b-form-checkbox
                >
            </b-col>
        </b-row>
        <b-row v-if="layout === 'concentric'">
            <b-col cols="1"></b-col>
            <b-col>
                <b-form-checkbox switch v-model="concentric_equidistant"
                    >Equidistant</b-form-checkbox
                >
            </b-col>
        </b-row>
        <b-row v-if="layout === 'concentric'">
            ...
            <b-col>
                <b-input-group prepend="Minimum Node Spacing">
                    <b-form-input
                        v-model="concentric_min_node_spacing"
                        type="number"
                        :number="true"
                        step="10"
                        min="0"
        ...
        <b-row v-if="layout === 'fcose'">
            ...
            <b-col>
                <b-input-group prepend="Ideal Edge Length">
                    <b-form-input
                        v-model="fcose_ideal_edge_length"
                        type="number"
                        :number="true"
                        step="5"
                        min="0"
        ...
        <b-row v-if="layout === 'cise'">
            ...
            <b-col>
                <b-input-group prepend="Ideal Edge Length">
                    <b-form-input
                        v-model="cise_ideal_edge_length"
                        type="number"
                        :number="true"
                        step="1"
                        min="0"
        ...
        <b-row>
            <b-col>
                <b-form-checkbox switch v-model="use_opacity"
                    >Use Transparency</b-form-checkbox
                >
            </b-col>
        </b-row>
    </b-container>
...
export default mixins(WindowMixin).extend({
    ...
    computed: {
        available_groups(): { text: string; value: string }[] {
            return this.dataview.selectedGroups.map((g) => ({
                text: g,
                value: g,
            }));
        },
