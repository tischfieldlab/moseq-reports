    ...
    <b-container fluid>
        ...
        <b-row>
            <b-col>
                <b-input-group prepend="Module Ordering">
                    <b-form-select
                        v-model="syllable_order_type"
                        :options="syllable_order_options"
                    ></b-form-select>
                </b-input-group>
            </b-col>
        </b-row>
        <b-row v-show="syllable_order_type === 'value'">
            ...
            <b-col>
                <b-input-group prepend="Sort by">
                    <b-form-select
                        v-model="syllable_order_group_value"
        ...
        <b-row v-show="syllable_order_type === 'value'">
            ...
            <b-col>
                <b-input-group prepend="Direction">
                    <b-form-select
                        v-model="syllable_order_direction"
        ...
        <b-row v-show="syllable_order_type === 'computed'">
            ...
            <b-col>
                <b-input-group prepend="Minuend Group">
                    <b-form-select
                        v-model="syllable_order_diff_minuend"
                        :options="group_options"
                    ></b-form-select>
                </b-input-group>
            </b-col>
        ...
        <b-row v-show="syllable_order_type === 'computed'">
            ...
            <b-col>
                <b-input-group prepend="Subtrahend Group">
                    <b-form-select
                        v-model="syllable_order_diff_subtrahend"
                        :options="group_options"
                    ></b-form-select>
                </b-input-group>
            </b-col>
        ...
        <b-row v-show="syllable_order_type === 'dataset'">
            ...
            <b-col>
                <b-input-group prepend="Dataset">
                    <DatasetPicker
                        v-model="syllable_order_dataset"
                        :dataview="dataview"
                        :owner="subid"
                    />
                </b-input-group>
