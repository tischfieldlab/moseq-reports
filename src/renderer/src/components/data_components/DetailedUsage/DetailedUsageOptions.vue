        ...
        <b-row>
            <b-col>
                ...
                <div
                    ...
                    v-html="boxplot_whisker_description"
                ></div>
            </b-col>
        </b-row>
        <b-row>
            ...
            whisker_options: [
                {
                    ...
                    text: "Tukey",
                    description:
                        "Whiskers extend up to 1.5 * IQR from 25<sup>th</sup> and 75<sup>th</sup> percentile",
                },
                {
