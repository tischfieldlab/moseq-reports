            ...
            >
                <div class="titlebar-button-container">
                    ...
                    <titlebar-button
                        ...
                        :icon="
                            isCollapsed ? 'caret-up-fill' : 'caret-down-fill'
                        "
                    />
                    <b-button-close
                        @click="this.onClose"
...
export default Vue.extend({
    ...
    watch: {
        aspect_ratio: {
            handler(newValue) {
                const aspect = this.applyAspectRatio(
                    this.windowWidth,
                    this.windowHeight
                );
    ...
    methods: {
        ...
        onDragStart(event: MouseEvent) {
            ...
            if (target.dataset.draggable === undefined) {
        ...
        onResize(event: MouseEvent) {
            if (this.isResizing && !this.isCollapsed) {
                ...
                const resizeType: ResizeType = this.resizeElement.dataset
                    .direction as ResizeType;
                ...
                switch (resizeType) {
                    ...
                    case ResizeType.TopLeft:
                        ...
                        appliedAspectRatio = this.applyAspectRatio(
                            newWidth,
                            newHeight
                        );
                        break;
