    ...
    (event: IpcRendererEvent, version: string) => {
        ...
        if (version === "") {
            ...
            createToast(
                ...
                "No Update Available",
                "succeess",
                "No new versions are available at this time!"
            );
            pushHistory(
                "succeess",
                "Updater: No new versions are available at this time!"
            );
            ...
            pushHistory(
                "danger",
                "Updater: Something happened while checking for updates"
            );
        } else {
...
ipcRenderer.on(
    "updater-finish-update-download",
                        ...
                        "b-button",
                        {
                            on: {
                                click: (e: any) => {
                                    ...
                                    ipcRenderer.send(
                                        "updater-restart-and-install-now"
                                    );
                                },
                            },
                            style: { "margin-right": "1em" },
                        ...
                        "b-button",
                        {
                            on: {
                                click: (e: any) => {
                                    ...
                                    ipcRenderer.send(
                                        "updater-restart-and-install-later"
                                    );
                                },
                            },
