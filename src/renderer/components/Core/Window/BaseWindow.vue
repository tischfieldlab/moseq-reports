<template>
    <div :id="id" class="msqWindow" :style="{
        left: `${window_xpos}px`,
        top: `${window_ypos}px`,
        ...
        <div class="msq-window-titlebar noselect" data-draggable="msq-titlebar" @mousedown="onDragStart"
            @mouseover="onTitlebarHover" @mouseleave="onTitlebarLeave">
            <span data-draggable="dataview-swatch" class="dataview-swatch" :id="`${id}-swatch`"
            ...
            <div class="titlebar-button-container">
                ...
                <BButton variant="link" :title="isCollapsed ? 'Show contents' : 'Hide contents'"
        ...
        <div :id="`window-content-${id}`" :hidden="isCollapsed" class="window-content" :style="{
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        // these are used in the template for rendering
        ...
        watch(
            ...
            (newValue) => {
                if (newValue) {
                    contentWidth.value = props.width;
