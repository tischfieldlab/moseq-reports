<template>
  <b-container fluid>
    ...
    <b-row>
      <b-form-checkbox v-model="only_subclip" switch>Only module subclip</b-form-checkbox>
    </b-row>
    <b-row>
    ...
    <b-row>
      <b-input-group prepend="Playback rate">
        ...
        <div class="figure-caption">
          A value of 1.0 results in normal playback speed. Values &gt; 1.0 result in faster playback, and values &gt; 0
          and &lt; 1.0 result in slower playback.
        </div>
      </b-input-group>
    </b-row>
  </b-container>
