...
} from "@render/components/Charts/ClusteredHeatmap/Options";
    ...
    columnLabelColors(): object | undefined {
      if (this.settings.color_columns) {
        return Object.fromEntries(
          this.aggregateView.slice().map((itm) => {
            return [itm.uuid, this.dataview.groupColors[this.dataview.selectedGroups.indexOf(itm.group)]];
          })
        );
      } else {
        return undefined;
