    ...
    <b-row>
      <b-col>
        <b-input-group prepend="Column Ordering">
          <b-form-select v-model="column_order_type" :options="order_type_options"></b-form-select>
        </b-input-group>
      </b-col>
    </b-row>
    <b-row v-show="column_order_type === 'value'">
      ...
      <b-col>
        <b-input-group prepend="Sort by">
          <b-form-select v-model="column_order_row_value" :options="row_options"></b-form-select>
        </b-input-group>
      </b-col>
    </b-row>
    <b-row v-show="column_order_type === 'value'">
    ...
    <b-row v-show="column_order_type === 'kcluster'">
      ...
      <b-col>
        <b-input-group prepend="Number of Clusters (K)">
          <b-form-input type="number" v-model="column_cluster_k" min="1" max="100"></b-form-input>
        </b-input-group>
      </b-col>
    </b-row>
...
import { OrderingType, SortOrderDirection } from "@render/components/Charts/ClusteredHeatmap/ClusteredHeatmap.types";
...
export default mixins(WindowMixin).extend({
  ...
  watch: {
    row_options: {
      handler() {
        if (this.column_order_row_value === undefined && this.row_options.length > 0) {
