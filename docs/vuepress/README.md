...
## Table of Contents
1. [Installation](user_guide/Installation.md)
2. [Using Moseq Reports](user_guide/GettingStarted.md)
3. [Tool Modules](user_guide/Tools.md)
4. [Developer Guide](user_guide/DeveloperGuide.md)
